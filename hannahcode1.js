...
var app= new Vue ({
    ...
    data: {
      ...
      statementpositions: [0,1,2,3,4,5,6,7],
      workexppositions: [0,1,2,3,4,5,6,7],
      educationpositions: [0,1,2,3,4,5,6,7],
      accomplishmentpositions: [0,1,2,3,4,5,6,7],
      extracurricularpositions: [0,1,2,3,4,5,6,7],
      languagespositions: [0,1,2,3,4,5,6,7],
      programspositions: [0,1,2,3,4,5,6,7],
      softskillspositions: [0,1,2,3,4,5,6,7],
      awardspositions: [0,1,2,3,4,5,6,7],
